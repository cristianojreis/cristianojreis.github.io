...
define('ember-simple-auth/test-support/index', ['exports', '@ember/test-helpers', 'ember-simple-auth/authenticators/test'], function (exports, _emberTestHelpers, _emberSimpleAuthAuthenticatorsTest) {
  'use strict';
  ...
  function ensureAuthenticator(owner) {
    ...
    if (!authenticator) {
      owner.register(TEST_CONTAINER_KEY, _emberSimpleAuthAuthenticatorsTest['default']);
    }
  }
  ...
  function authenticateSession(sessionData) {
    var _getContext = (0, _emberTestHelpers.getContext)(),
    ...
    return session.authenticate(TEST_CONTAINER_KEY, sessionData).then(function () {
      return (0, _emberTestHelpers.settled)();
    });
  }
  ...
  function currentSession() {
    var _getContext2 = (0, _emberTestHelpers.getContext)(),
  ...
  function invalidateSession() {
    var _getContext3 = (0, _emberTestHelpers.getContext)(),
